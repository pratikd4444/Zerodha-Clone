        ...
        <div className='container ' >
            <div className='row text-center'>
                ...
                <div className='col-4 p-3 mt-5'>
                    <img className='mb-3' style={{width:"50%"}} src='media/images/zerodhaFundhouse - Copy - Copy.png' />
                    ...
                    <img style={{width:"50%", marginTop:"20px", marginBottom:"15px"}}  src='media/images/streakLogo.png' />
                ...
                <div className='col-4 p-3 mt-5'>
                    <img  className='mb-4' style={{width:"60%"}} src='media/images/sensibullLogo.svg' />
                    ...
                    <img style={{width:"60%", marginTop:"25px", marginBottom:"15px"}} src='media/images/smallcaseLogo.png' />
                ...
                <div className='col-4 p-3 mt-5'>
                    <img  className='mb-2' style={{width:"40%"}}   src='media/images/tijori.svg' />
                    ...
                    <img className='mb-5 mt-3' style={{width:"30%"}}   src='media/images/dittoLogo.png' />
