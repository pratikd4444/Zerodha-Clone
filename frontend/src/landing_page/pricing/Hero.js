...
function Hero() {
    return ( 
        ...
        <p className='text-center mb-5 text-muted fs-5' >List of all charges and taxes</p>
            <div className='col p-3 text-center'>
                <img className='mb-3'style={{ width: "90%", maxHeight: "200px" }} src='media/images/pricingEquity.svg' alt='prcinigequity' />
            ...
            <div className='col p-3'>
                <img className='mb-3' style={{ width: "90%", maxHeight: "200px" }} src='media/images/pricing2.svg' alt='pricing2' />
    ...
    Flat ₹ 20 or 0.03% (whichever is lower) per executed order on intraday trades across equity, currency, and commodity trades. Flat ₹20 on all option trades.</p>
            ...
            <div className='col p-3 text-center'>
                <img className='mb-3' style={{ width: "90%", maxHeight: "200px" }} src='media/images/pricingEquity.svg' alt='pricingequity' />
